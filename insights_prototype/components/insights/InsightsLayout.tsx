    ...
    return (
        <div className="flex flex-col h-screen bg-background text-foreground overflow-hidden selection:bg-primary/30">
            ...
            <main className="flex-1 grid grid-cols-12 overflow-hidden">
                ...
                <aside className="col-span-3 border-r border-zinc-800 bg-zinc-900/50 overflow-hidden backdrop-blur-sm">
                    <InsightsFeed />
                </aside>
                ...
                <aside className="col-span-3 border-l border-zinc-800 bg-zinc-900 shadow-2xl z-10">
                    <TalkCopilot />
                </aside>
